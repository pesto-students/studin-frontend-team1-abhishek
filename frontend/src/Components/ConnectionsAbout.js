      ...
      <Box sx={{ mx: "2%", my: "", border: "", bgcolor: "" }}>
        <Grid container sx={{ border: "", }}>
          <Grid item lg={12} md={12} sm={12} xs={12} sx={{ my: "1%", }}>
            <Typography sx={{ ml: "2%", }}>
              Name : {userConnection.firstName} {userConnection.lastName}
              {/* Name: Danish Khan Viquar */}
            </Typography>
          ...
          <Grid item lg={12} md={12} sm={12} xs={12} sx={{}}>
            <Typography sx={{ ml: "2%", bgcolor: "", width: "50%", borderRadius: "5px" }} >
              School  : {userConnection.schoolName}
              {/* KGM National High */}
            </Typography>
            <Divider sx={{ borderColor: "secondary.light", ml: "2%", mr: "60%" }} />
          </Grid>
          <Grid item lg={12} md={12} sm={12} xs={12} sx={{ my: "1%" }}>
            <Typography sx={{ ml: "2%", bgcolor: "", width: "50%", borderRadius: "5px" }}>
              College  : {userConnection.collegeName}
              {/* DNP colleage of enginnering */}
            </Typography>
            <Divider sx={{ borderColor: "secondary.light", ml: "2%", mr: "60%" }} />
          </Grid>
          <Grid item lg={12} md={12} sm={12} xs={12} sx={{}}>
